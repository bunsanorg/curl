...
public:
    explicit basic_mock_option(mock_option_info *const info):
        m_info(info) {}
...
using mock_option_by_curl = basic_mock_option<
    options::retention_policy::by_curl,
    Ids...
>;

template <CURLoption ... Ids>
using mock_option_by_wrapper = basic_mock_option<
    options::retention_policy::by_wrapper,
    Ids...
>;
