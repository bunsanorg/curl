...
namespace bunsan{namespace curl{namespace http
{
    ...
    {
    public:
        explicit plain_const_iterator(
            const const_iterator &iterator1_begin,
            const const_iterator &iterator1_end):
                m_iterator1_begin(iterator1_begin),
                m_iterator1_end(iterator1_end)
        {
            propagate();
            normalize();
        }
    ...
    private:
        ...
        bool is_end() const
        {
            return m_iterator1_begin == m_iterator1_end;
        }

        bool is_inner_end() const
        {
            return m_iterator2_begin == m_iterator2_end;
        }
