...
namespace bunsan{namespace curl{namespace options
{
    ...
    BUNSAN_CURL_OPTION_WRAPPED(proxy_transfer_mode, CURLOPT_PROXY_TRANSFER_MODE, bool_01)
    ...
    BUNSAN_CURL_OPTION_WRAPPED(timecondition, CURLOPT_TIMECONDITION, enum_<timecond>)
