...
namespace bunsan{namespace curl{namespace options
{
    ...
    BUNSAN_CURL_OPTION_WRAPPED(socks5_gssapi_nec, CURLOPT_SOCKS5_GSSAPI_NEC, bool_01)
    ...
    BUNSAN_CURL_OPTION_DEFAULT_WRAPPED(
        dns_cache_timeout,
        CURLOPT_DNS_CACHE_TIMEOUT,
        seconds,
        -1
    )
    // obsolete BUNSAN_CURL_OPTION_WRAPPED(dns_use_global_cache, CURLOPT_DNS_USE_GLOBAL_CACHE, bool_01)
    BUNSAN_CURL_OPTION_WRAPPED(buffersize, CURLOPT_BUFFERSIZE, long_) // TODO Do we need negative checks?
